    ...
    <p id="demoText"></p>
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-form-item">
            ...
            <input type="checkbox" name="model" value="<?php echo $vo['su_pl_id']; ?>" title="<?php echo $vo['pl_title']; ?>" checked>
