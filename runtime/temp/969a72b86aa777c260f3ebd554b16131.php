    ...
    <div class="layui-card">
      <div class="layui-card-body" style="padding: 15px;">
            ...
            <div class="layui-input-block">
				<select name="dg_id" id="dg_id">
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<option value="<?php echo $vo['dg_id']; ?>"><?php echo $vo['dg_title']; ?></option>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input name="name" type="text" class="layui-input" id="name"   placeholder="用户名">
            </div>
          </div>  
         ...
         <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input name="pass" type="text" class="layui-input" id="pass"   placeholder="密码">
            </div>
          </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input name="smname" type="text" class="layui-input" id="smname"   placeholder="真实姓名">
            </div>
          </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input name="zfb" type="text" class="layui-input" id="zfb"   placeholder="支付宝">
            </div>
          </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input name="wx" type="text" class="layui-input" id="wx"   placeholder="微信号">
            </div>
          </div>
	  ...
	  <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="radio" name="du_tmp" value="1" title="所有功能" checked="">
              <input type="radio" name="du_tmp" value="2" title="指定模板">
            </div>
          </div>
         ...
         <div class="layui-form-item">
            ...
            <input type="checkbox" name="model" value="<?php echo $vo['wxgt_id']; ?>" title="<?php echo $vo['wxgt_title']; ?>" checked>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
          </div>
...
$(".sub").click(function(){
	...
	$.ajax({
		type:"POST",
		url:"<?php echo url('distribution/add'); ?>",
		dataType:"json",
		data:{
			dg_id:dg_id,
			name:name,
