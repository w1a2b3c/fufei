              ...
              <dl class="layui-nav-child">
                <dd data-name="console" class="layui-this">
                  <a lay-href="<?php echo url('center/home'); ?>">数据总览</a>
                    ...
                    <li data-name="数据大屏" class="layui-nav-item">
						<a href="javascript:;" lay-href="<?php echo url('data/index'); ?>" lay-tips="数据大屏" lay-direction="2">
