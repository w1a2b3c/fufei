        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
				<select name="headimg" id="headimg">
                    <option value="qq">扩列，交友，吃瓜</option>
                    <option value="za">综合随机</option>
				</select>
            </div>
          </div> 
  ...
  <div class="layui-tab-content" >
    <div class="layui-tab-item layui-show"> 
		...
		<div class="layui-form-item">
			...
			<input type="hidden" id="wxgt_headimg" name="wxgt_headimg" value="">
            <div class="layui-input-block">
  ...
  <div class="layui-upload-list">
    ...
    <p id="demoText"></p>
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input name="subtitle" type="text"  class="layui-input" id="subtitle" placeholder="副标题">
            </div>
          </div> 
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input name="redcount" type="text"  class="layui-input" id="redcount" placeholder="阅读数" value="10万+">
            </div>
          </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input name="dzcount" type="number"  class="layui-input" id="dzcount" placeholder="点赞数" value="3659">
            </div>
          </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input name="xxcount" type="number"  class="layui-input" id="xxcount" placeholder="点赞数" value="665">
            </div>
          </div>
    ...
    <div class="layui-tab-item"> 
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input name="qjj_title" type="text"  class="layui-input" id="qjj_title" placeholder="区块一标题" value="群简介">
            </div>
          </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
            	<textarea name="qjj_content" type="text"  class="layui-input" id="qjj_content"cols="" rows=""></textarea>
            </div>
          </div>  
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input name="kuai_title" type="text"  class="layui-input" id="kuai_title" placeholder="区块二标题" value="常见问题">
            </div>
          </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <textarea class="layui-input" name="kuai_content" id="kuai_content" style="height:180px;">副标题1----回答问题1
副标题2----回答问题2
副标题3----回答问题3</textarea>
            </div>
          </div>     
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input name="kuai_title1" type="text"  class="layui-input" id="kuai_title1" placeholder="区块三标题">
            </div>
          </div>
	...
	<script id="editor" type="text/plain" style="width:100%;height:250px;"></script>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <textarea class="layui-input" name="qunyou_content" id="qunyou_content" style="height:180px;">清澈的眼眸----真的太感谢群主了----128
真的太感谢群主了----323
真的太感谢群主了----666
真的太感谢群主了----32
真的太感谢群主了----65</textarea>
            </div>
          </div>  
...
$(".sub").click(function(){
	...
	$.ajax({
		type:"POST",
		url:"<?php echo url('wxgrouptmp/add'); ?>",
		dataType:"json",
		data:{
