  ...
  <div class="layui-tab-content" >
    <div class="layui-tab-item layui-show">  
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-form-item">
            <label class="layui-form-label">多类型支付</label>
            <div class="layui-input-block">
              <input type="radio" name="wxonoffxx" value="1" title="开启" <?php if($info['type'] == 1): ?>checked=""<?php endif; ?>>
              <input type="radio" name="wxonoffxx" value="2" title="关闭" <?php if($info['type'] == 2): ?>checked=""<?php endif; ?>>
...
$(".sub").click(function(){
	...
	var wxonoffxx = $("input[name='wxonoffxx']:checked").val();
